...
namespace PokemonApp.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        public IActionResult GetPokemonByOwner(int ownerId)
        {
            ...
            var owner = _mapper.Map<List<PokemonDto>>(_ownerRepository.GetPokemonByOwner(ownerId)).ToList();
        ...
        public IActionResult CreateOwner([FromQuery] int countryId, [FromBody] OwnerDto ownerCreate)
        {
            ...
            var category = _ownerRepository.GetOwners()
                .Where(c => (
                (c.FirstName.Trim().ToUpper() == ownerCreate.FirstName.TrimEnd().ToUpper()) && (c.LastName.Trim().ToUpper() == ownerCreate.LastName.TrimEnd().ToUpper())
                )).FirstOrDefault();
